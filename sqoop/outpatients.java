// ORM class for table 'outpatients'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sun Apr 22 10:13:15 COT 2018
...
public class outpatients extends SqoopRecord  implements DBWritable, Writable {
  ...
  public outpatients with_DISCHARGE(String DISCHARGE) {
    this.DISCHARGE = DISCHARGE;
    return this;
  }
  ...
  public outpatients with_RECORD_ID(String RECORD_ID) {
    this.RECORD_ID = RECORD_ID;
    return this;
  }
  ...
  public outpatients with_THCIC_ID(String THCIC_ID) {
    this.THCIC_ID = THCIC_ID;
    return this;
  }
  ...
  public outpatients with_SEX_CODE(String SEX_CODE) {
    this.SEX_CODE = SEX_CODE;
    return this;
  }
  ...
  public outpatients with_COUNTY(String COUNTY) {
    this.COUNTY = COUNTY;
    return this;
  }
  ...
  public outpatients with_PAT_STATE(String PAT_STATE) {
    this.PAT_STATE = PAT_STATE;
    return this;
  }
  ...
  public outpatients with_PAT_COUNTRY(String PAT_COUNTRY) {
    this.PAT_COUNTRY = PAT_COUNTRY;
    return this;
  }
  ...
  public outpatients with_PAT_AGE(String PAT_AGE) {
    this.PAT_AGE = PAT_AGE;
    return this;
  }
  ...
  public outpatients with_PRINC_DIAG_CODE(String PRINC_DIAG_CODE) {
    this.PRINC_DIAG_CODE = PRINC_DIAG_CODE;
    return this;
  }
  ...
  public outpatients with_OTH_DIAG_CODES(String OTH_DIAG_CODES) {
    this.OTH_DIAG_CODES = OTH_DIAG_CODES;
    return this;
  }
  ...
  public outpatients with_E_CODES(String E_CODES) {
    this.E_CODES = E_CODES;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof outpatients)) {
      return false;
    }
    outpatients that = (outpatients) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.DISCHARGE = JdbcWritableBridge.readString(1, __dbResults);
    this.RECORD_ID = JdbcWritableBridge.readString(2, __dbResults);
    this.THCIC_ID = JdbcWritableBridge.readString(3, __dbResults);
    this.SEX_CODE = JdbcWritableBridge.readString(4, __dbResults);
    this.COUNTY = JdbcWritableBridge.readString(5, __dbResults);
    this.PAT_STATE = JdbcWritableBridge.readString(6, __dbResults);
    this.PAT_COUNTRY = JdbcWritableBridge.readString(7, __dbResults);
    this.PAT_AGE = JdbcWritableBridge.readString(8, __dbResults);
    this.PRINC_DIAG_CODE = JdbcWritableBridge.readString(9, __dbResults);
    this.OTH_DIAG_CODES = JdbcWritableBridge.readString(10, __dbResults);
    this.E_CODES = JdbcWritableBridge.readString(11, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeString(DISCHARGE, 1 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(RECORD_ID, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(THCIC_ID, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(SEX_CODE, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(COUNTY, 5 + __off, 12, __dbStmt);
    ...
    JdbcWritableBridge.writeString(PAT_AGE, 8 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(PRINC_DIAG_CODE, 9 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(OTH_DIAG_CODES, 10 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(E_CODES, 11 + __off, 12, __dbStmt);
    return 11;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    outpatients o = (outpatients) super.clone();
    return o;
  }

  public void clone0(outpatients o) throws CloneNotSupportedException {
  }
